...
public class TelaParticipante {
	...
	private void initialize() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if (table.getSelectedRow() >= 0){
						...
						int escolha = JOptionPane.showOptionDialog(null, "Confirma exclusao de participante "+ nome, "Alerta",
		...
		timer.setDelay(3000);	//10segundos
	...
	public void listagem() {
		try{
			...
			for(Participante p : lista) {
				...
				if(p instanceof Convidado conv)   //conv � a mesma referencia de p
