...
public abstract class DAO<T> implements DAOInterface<T> {
	...
	public static void open(){
		if(manager==null){		//padrão de projeto Singleton
			/*****************************************************************************
			...
			// ou
			// desativar o cache de objetos seletivamente em cada classe com @Cacheable
			propriedadesXMLalteradas.setProperty("javax.persistence.sharedCache.mode", "NONE");
			//propriedadesXMLalteradas.setProperty("javax.persistence.sharedCache.mode", "DISABLE_SELECTIVE");
